  ...
  (() => {
          ...
          (T = function () {
            ...
            function I(E, T, I) {
              if (E instanceof A) {
                var N = E;
                I = T;
              } else N = A.fromCompiled(E, T);
              for (var O in ((this.grammar = N),
              (this.options = { keepHistory: !1, lexer: N.lexer || new S() }),
              I || {}))
                this.options[O] = I[O];
            ...
            return (
              ...
              (E.prototype.toString = function (E) {
                var T =
                  void 0 === E
                    ? this.symbols.map(N).join(" ")
                    : this.symbols.slice(0, E).map(N).join(" ") +
                      " ● " +
                      this.symbols.slice(E).map(N).join(" ");
                return this.name + " → " + T;
              }),
                ...
                for (
                  ...
                  if (N.isComplete) {
                    if ((N.finish(), N.data !== I.fail)) {
                      for (var O = N.wantedBy, L = O.length; L--; ) {
                        var C = O[L];
                        this.complete(C, N);
                      }
                      if (N.reference === this.index) {
                        var _ = N.rule.name;
                        (this.completed[_] = this.completed[_] || []).push(N);
                      }
                    }
                  } else {
                    if ("string" != typeof (_ = N.rule.symbols[N.dot])) {
                      this.scannable.push(N);
                      continue;
                    }
                    if (R[_]) {
                      if ((R[_].push(N), A.hasOwnProperty(_))) {
                        var e = A[_];
                ...
                if ("string" == typeof R) {
                  ...
                  return (
                    ...
                    (T += A.map(function (E, T) {
                      return O(this.line - A.length + T + 1, N) + " " + E;
                    }, this).join("\n")) +
                      "\n" +
                      O("", N + I) +
                      "^\n"
              ...
              (I.prototype.feed = function (E) {
                ...
                for (A.reset(E, this.lexerState); ; ) {
                  ...
                  var O = this.current + 1;
                  (I = new R(this.grammar, O)), this.table.push(I);
                  for (
                    var L,
                  ...
                  this.options.keepHistory && (N.lexerState = A.save()),
                    this.current++;
                }
                return (
                  N && (this.lexerState = A.save()),
    ...
    return (
      (() => {
        "use strict";
        function E(E) {
          return "tabularLeft" === E.indentStyle ||
            "tabularRight" === E.indentStyle
            ? " ".repeat(10)
            : E.useTabs
              ? "\t"
              : " ".repeat(E.tabWidth);
        ...
        const L = (E) => ({
          ...
          C = L(1 / 0),
          _ = (E) => (T) => T.type === E.type && T.text === E.text,
          e = {
            ARRAY: _({ text: "ARRAY", type: I.RESERVED_KEYWORD }),
            BY: _({ text: "BY", type: I.RESERVED_KEYWORD }),
            SET: _({ text: "SET", type: I.RESERVED_CLAUSE }),
            STRUCT: _({ text: "STRUCT", type: I.RESERVED_KEYWORD }),
            WINDOW: _({ text: "WINDOW", type: I.RESERVED_CLAUSE }),
          },
          P = (E) =>
            E === I.RESERVED_KEYWORD ||
            E === I.RESERVED_FUNCTION_NAME ||
            E === I.RESERVED_PHRASE ||
            E === I.RESERVED_CLAUSE ||
            E === I.RESERVED_SELECT ||
            E === I.RESERVED_SET_OPERATION ||
            E === I.RESERVED_JOIN ||
            E === I.ARRAY_KEYWORD ||
            E === I.CASE ||
            E === I.END ||
          ...
          U = (E, T, R) => {
            if (E.type === I.IDENTIFIER) {
              ...
              if (A && n(A))
                return Object.assign(Object.assign({}, E), {
                  type: I.ARRAY_IDENTIFIER,
                });
            }
            return E;
          },
          s = (E, T, R) => {
            if (E.type === I.RESERVED_KEYWORD) {
              const A = r(R, T);
              if (A && n(A))
                return Object.assign(Object.assign({}, E), {
                  type: I.ARRAY_KEYWORD,
                });
            }
            return E;
          },
          ...
          r = (E, T, R = 1) => {
            let A = 1;
            for (; E[T + A * R] && i(E[T + A * R]); ) A++;
            return E[T + A * R];
          },
          G = (E) => E.type === I.OPEN_PAREN && "(" === E.text,
          n = (E) => E.type === I.OPEN_PAREN && "[" === E.text,
          i = (E) => E.type === I.BLOCK_COMMENT || E.type === I.LINE_COMMENT;
        function a(E, T) {
        ...
        class H {
          ...
          save() {}
          formatError(E) {
            const { line: T, col: R } = a(this.input, E.start);
        ...
        const Y = new H((E) => []),
          ...
          W = {
            ...
            ParserRules: [
              ...
              },
              {
                ...
                symbols: [
                  Y.has("DELIMITER") ? { type: "DELIMITER" } : DELIMITER,
                ],
              },
              {
                name: "statement$subexpression$1",
                symbols: [Y.has("EOF") ? { type: "EOF" } : EOF],
              },
              {
                name: "statement",
                symbols: [
              ...
              },
              {
                ...
                symbols: [Y.has("ASTERISK") ? { type: "ASTERISK" } : ASTERISK],
              ...
              },
              {
                ...
                postprocess: ([E, T]) => l(E, { trailing: T }),
              },
              {
              ...
              },
              {
                ...
                symbols: [
                  "expression",
                  "_",
                  Y.has("DOT") ? { type: "DOT" } : DOT,
                  "_",
                  "property_access$subexpression$1",
                ],
                postprocess: ([E, T, R, A, [S]]) => ({
                  type: o.property_access,
                  object: l(E, { trailing: T }),
                  property: l(S, { leading: A }),
                }),
              },
              {
                name: "between_predicate",
                symbols: [
                  Y.has("BETWEEN") ? { type: "BETWEEN" } : BETWEEN,
                  "_",
                  "expression",
                  "_",
                  Y.has("AND") ? { type: "AND" } : AND,
                  "_",
                  "expression",
                ],
                postprocess: ([E, T, R, A, S, I, N]) => ({
                  type: o.between_predicate,
                  betweenKw: V(E),
                  expr1: [l(R, { leading: T, trailing: A })],
                  andKw: V(S),
                  expr2: [l(N, { leading: I })],
                }),
              },
              ...
              },
              {
                ...
                symbols: [
                  Y.has("CASE") ? { type: "CASE" } : CASE,
                  "_",
                  "case_expression$ebnf$1",
                  "case_expression$ebnf$2",
                  Y.has("END") ? { type: "END" } : END,
                ],
                postprocess: ([E, T, R, A, S]) => ({
                  type: o.case_expression,
                  caseKw: l(V(E), { trailing: T }),
                  endKw: V(S),
                  expr: R || [],
                  clauses: A,
                }),
              },
              {
                name: "case_clause",
                symbols: [
                  Y.has("WHEN") ? { type: "WHEN" } : WHEN,
                  "_",
                  "expression_chain_",
                  Y.has("THEN") ? { type: "THEN" } : THEN,
                  "_",
                  "expression_chain_",
                ],
                postprocess: ([E, T, R, A, S, I]) => ({
                  type: o.case_when,
                  whenKw: l(V(E), { trailing: T }),
                  thenKw: l(V(A), { trailing: S }),
                  condition: R,
                  result: I,
                }),
              },
              {
                name: "case_clause",
                symbols: [
                  Y.has("ELSE") ? { type: "ELSE" } : ELSE,
                  "_",
                  "expression_chain_",
                ],
                postprocess: ([E, T, R]) => ({
                  type: o.case_else,
                  elseKw: l(V(E), { trailing: T }),
                  result: R,
                }),
              },
              {
                name: "comma$subexpression$1",
                symbols: [Y.has("COMMA") ? { type: "COMMA" } : COMMA],
              },
              {
                name: "comma",
              ...
              },
              {
                ...
                postprocess: ([[E]]) => ({ type: o.operator, text: E.text }),
              },
              {
                name: "operator$subexpression$1",
                symbols: [Y.has("OPERATOR") ? { type: "OPERATOR" } : OPERATOR],
              },
              {
                name: "operator",
              ...
              },
              {
                ...
                symbols: [
                  Y.has("IDENTIFIER") ? { type: "IDENTIFIER" } : IDENTIFIER,
                ],
              },
              {
                name: "identifier$subexpression$1",
                symbols: [
                  Y.has("QUOTED_IDENTIFIER")
              ...
              {
                name: "identifier$subexpression$1",
                symbols: [Y.has("VARIABLE") ? { type: "VARIABLE" } : VARIABLE],
              },
              {
                name: "identifier",
                symbols: ["identifier$subexpression$1"],
                postprocess: ([[E]]) => ({ type: o.identifier, text: E.text }),
              },
              {
                name: "parameter$subexpression$1",
                symbols: [
                  Y.has("NAMED_PARAMETER")
              ...
              },
              {
                ...
                symbols: [Y.has("NUMBER") ? { type: "NUMBER" } : NUMBER],
              },
              {
                name: "literal$subexpression$1",
                symbols: [Y.has("STRING") ? { type: "STRING" } : STRING],
              },
              {
                name: "literal",
                symbols: ["literal$subexpression$1"],
                postprocess: ([[E]]) => ({ type: o.literal, text: E.text }),
              },
              {
                name: "keyword$subexpression$1",
                symbols: [
                  Y.has("RESERVED_KEYWORD")
              ...
              {
                name: "keyword$subexpression$1",
                symbols: [Y.has("AND") ? { type: "AND" } : AND],
              },
              {
                name: "keyword$subexpression$1",
                symbols: [Y.has("OR") ? { type: "OR" } : OR],
              },
              {
                name: "keyword$subexpression$1",
                symbols: [Y.has("XOR") ? { type: "XOR" } : XOR],
              },
              {
                name: "keyword",
              ...
              },
              {
                ...
                symbols: [Y.has("WHEN") ? { type: "WHEN" } : WHEN],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [Y.has("THEN") ? { type: "THEN" } : THEN],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [Y.has("ELSE") ? { type: "ELSE" } : ELSE],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [Y.has("END") ? { type: "END" } : END],
              },
              {
                name: "other_keyword",
          ...
          p = W,
          { Parser: X, Grammar: c } = O(),
          u = (E) => E[E.length - 1],
          m = (E) =>
            E.sort((E, T) => T.length - E.length || E.localeCompare(T)),
          h = (E) => E.reduce((E, T) => Math.max(E, T.length), 0),
          K = (E) => E.replace(/\s+/gu, " "),
          d = (E) => {
        ...
        class J {
            ...
            for (const T of E)
              switch (T) {
                ...
                case x.MANDATORY_NEWLINE:
                  this.trimHorizontalWhitespace(),
                    this.addNewline(x.MANDATORY_NEWLINE);
                  break;
                case x.INDENT:
                  this.addIndentation();
                  break;
          ...
          trimHorizontalWhitespace() {
            for (; g(u(this.items)); ) this.items.pop();
          }
          trimWhitespace() {
            for (; $(u(this.items)); ) this.items.pop();
          }
          addNewline(E) {
        ...
        const g = (E) => E === x.SPACE || E === x.SINGLE_INDENT,
          $ = (E) => E === x.SPACE || E === x.SINGLE_INDENT || E === x.NEWLINE;
        const w = "top-level";
        class Q {
          constructor(E) {
          ...
          decreaseTopLevel() {
            this.indentTypes.length > 0 &&
              u(this.indentTypes) === w &&
              this.indentTypes.pop();
          }
          decreaseBlockLevel() {
            for (
              ;
              this.indentTypes.length > 0 && this.indentTypes.pop() === w;
        ...
        class v extends J {
          ...
          addToLength(E) {
            if ("string" == typeof E)
              ...
              if (E === x.MANDATORY_NEWLINE || E === x.NEWLINE) throw new Z();
              E === x.INDENT || E === x.SINGLE_INDENT || E === x.SPACE
                ? this.trailingSpace ||
                  (this.length++, (this.trailingSpace = !0))
                : (E !== x.NO_NEWLINE && E !== x.NO_SPACE) ||
                  (this.trailingSpace &&
        ...
        class k {
          ...
          formatParenthesis(E) {
            ...
            R
              ? (this.layout.add(E.openParen),
                ...
                this.layout.add(x.NO_SPACE, E.closeParen, x.SPACE))
              : (this.layout.add(E.openParen, x.NEWLINE),
                T(this.cfg)
                  ? (this.layout.add(x.INDENT),
                    (this.layout = this.formatSubExpression(E.children)))
                  : (this.layout.indentation.increaseBlockLevel(),
                    this.layout.add(x.INDENT),
                    (this.layout = this.formatSubExpression(E.children)),
                    this.layout.indentation.decreaseBlockLevel()),
                this.layout.add(x.NEWLINE, x.INDENT, E.closeParen, x.SPACE));
          }
          formatBetweenPredicate(E) {
            this.layout.add(this.showKw(E.betweenKw), x.SPACE),
          ...
          formatCaseExpression(E) {
            this.formatNode(E.caseKw),
              ...
              this.layout.indentation.decreaseBlockLevel(),
              this.layout.add(x.NEWLINE, x.INDENT),
          ...
          formatClause(E) {
            T(this.cfg)
              ...
              T(this.cfg) || this.layout.add(x.INDENT),
              (this.layout = this.formatSubExpression(E.children)),
            ...
            this.withComments(E.limitKw, () => {
              ...
              E.offset
                ? ((this.layout = this.formatSubExpression(E.offset)),
                  this.layout.add(x.NO_SPACE, ",", x.SPACE),
          ...
          formatOperator({ text: E }) {
            ...
            (null === (T = this.dialectCfg.alwaysDenseOperators) || void 0 === T
              ? void 0
              : T.includes(E))
              ? this.layout.add(x.NO_SPACE, E)
              : ":" === E
                ? this.layout.add(x.NO_SPACE, E, x.SPACE)
                : this.layout.add(E, x.SPACE);
          }
          formatComma(E) {
            this.inline
              ? this.layout.add(x.NO_SPACE, ",", x.SPACE)
              : this.layout.add(x.NO_SPACE, ",", x.NEWLINE, x.INDENT);
          }
          withComments(E, T) {
            this.formatComments(E.leadingComments),
              T(),
          ...
          formatLineComment(E) {
            y(E.precedingWhitespace || "")
              ...
              : this.layout.getLayoutItems().length > 0
                ...
                : this.layout.add(E.text, x.MANDATORY_NEWLINE, x.INDENT);
          }
          ...
          isMultilineBlockComment(E) {
            return y(E.text) || y(E.precedingWhitespace || "");
          }
          splitBlockComment(E) {
            return E.split(/\n/).map((E) =>
              /^\s*\*/.test(E)
          ...
          formatInlineExpression(E) {
            ...
            try {
              return new k({
                ...
                dialectCfg: this.dialectCfg,
                params: this.params,
                layout: new v(this.cfg.expressionWidth),
                inline: !0,
              }).format(E);
            } catch (E) {
              if (E instanceof Z)
          ...
          formatJoin(E) {
            T(this.cfg)
              ? (this.layout.indentation.decreaseTopLevel(),
                this.layout.add(x.NEWLINE, x.INDENT, this.showKw(E), x.SPACE),
                this.layout.indentation.increaseTopLevel())
              : this.layout.add(x.NEWLINE, x.INDENT, this.showKw(E), x.SPACE);
          }
          formatKeyword(E) {
            ...
            "before" === this.cfg.logicalOperatorNewline
              ? T(this.cfg)
                ? (this.layout.indentation.decreaseTopLevel(),
                  ...
                  this.layout.indentation.increaseTopLevel())
                : this.layout.add(x.NEWLINE, x.INDENT, this.showKw(E), x.SPACE)
              : this.layout.add(this.showKw(E), x.NEWLINE, x.INDENT);
          }
          showKw(E) {
            return ((E) => E === I.AND || E === I.OR || E === I.XOR)(
              (T = E.tokenType),
            ) ||
              T === I.RESERVED_CLAUSE ||
              T === I.RESERVED_SELECT ||
              T === I.RESERVED_SET_OPERATION ||
              T === I.RESERVED_JOIN ||
              T === I.LIMIT
              ? (function (E, T) {
                ...
                })(this.showNonTabularKw(E), this.cfg.indentStyle)
        ...
        class q {
          constructor(E) {
            (this.cfg = E), (this.params = new S(this.cfg.params));
          }
          tokenizer() {
          ...
          cachedTokenizer() {
            ...
            return (
              E.cachedTokenizer || (E.cachedTokenizer = this.tokenizer()),
              E.cachedTokenizer
            );
          }
          formatOptions() {
          ...
          parse(E) {
            return (function (E) {
              ...
              const R = new H((R) => {
                  return [
                    ...((A = E.tokenize(R, T)), A.map(D).map(M).map(U).map(s)),
                    L(R.length),
                  ];
                  var A;
                }),
                A = new X(c.fromCompiled(p), { lexer: R });
              return {
                parse: (E, R) => {
                  T = R;
            ...
            })(this.cachedTokenizer()).parse(E, this.cfg.paramTypes || {});
          }
          formatAst(E) {
          ...
          postFormat(T) {
            return (
                  ...
                  for (let E = 0; E < T.length; E++) {
                    if (T[E].match(/^\s*SELECT/i)) {
                      ...
                      if (T[E].match(/.*,$/)) A = [T[E]];
                        ...
                        if (
                          (R.push(T[E]), T[E].match(/^\s*SELECT\s+.+(?!,$)/i))
                        )
                          continue;
                        A.push(T[++E]);
                      }
                      ...
                      const S = A.map((E) => ({
                        ...
                        })).map(({ line: E, matches: T }) =>
                          T
                            ? { precedingText: T[1], as: T[2], alias: T[3] }
                            : { precedingText: E },
                        ),
                        I = h(
                          S.map(({ precedingText: E }) =>
                            E.replace(/\s*,\s*$/, ""),
                          ),
                        );
                      (A = S.map(
                        ({ precedingText: E, as: T, alias: R }) =>
                          E +
                          (R
                            ? " ".repeat(I - E.length + 1) +
                              (null != T ? T : "") +
              ...
              ("before" !== this.cfg.commaPosition &&
                "tabular" !== this.cfg.commaPosition) ||
                (T = (function (E, T, R) {
                  return (function (E) {
                    const T = [];
                    for (let R = 0; R < E.length; R++) {
                      const A = [E[R]];
                      for (; E[R].match(/.*,$/); ) R++, A.push(E[R]);
                      T.push(A);
                    }
                    return T;
                  })(E.split("\n"))
                    ...
                    .join("\n");
                })(T, this.cfg.commaPosition, E(this.cfg))),
              T
            );
          }
        }
        const j = (E) => E.replace(/[.*+?^${}()|[\]\\]/gu, "\\$&"),
          z = /\s+/uy,
          EE = (E) => new RegExp(`(?:${E})`, "uy"),
          TE = (E) =>
            E.split("")
              .map((E) =>
                / /gu.test(E)
        ...
        class eE {
          ...
          createParseError() {
            const E = this.input.slice(this.index, this.index + 10),
              { line: T, col: R } = a(this.input, this.index);
            return new Error(
        ...
        class UE {
          ...
          exec(E) {
            let T,
              R = "",
              A = 0;
            if (!(T = this.matchSection(PE, E))) return null;
            for (R += T, A++; A > 0; )
              if ((T = this.matchSection(PE, E))) (R += T), A++;
              else if ((T = this.matchSection(ME, E))) (R += T), A--;
              else {
                if (!(T = this.matchSection(DE, E))) return null;
                R += T;
              }
            return [R];
          }
            ...
            return this.validRules([
              {
                ...
                regex: E.nestedBlockComments ? new UE() : /(\/\*[^]*?\*\/)/uy,
              },
              {
                type: I.LINE_COMMENT,
                regex:
                  ((A =
                    null !== (T = E.lineCommentTypes) && void 0 !== T
                      ? T
                      : ["--"]),
                  new RegExp(
                    `(?:${A.map(j).join("|")}).*?(?=\r\n|\r|\n|$)`,
              ...
              { type: I.QUOTED_IDENTIFIER, regex: LE(E.identTypes) },
              {
                type: I.NUMBER,
                regex:
              ...
              {
                type: I.RESERVED_PHRASE,
                regex: AE(
                  null !== (R = E.reservedPhrases) && void 0 !== R ? R : [],
                  E.identChars,
                ),
                text: tE,
              },
              { type: I.CASE, regex: /CASE\b/iuy, text: tE },
              { type: I.END, regex: /END\b/iuy, text: tE },
              { type: I.BETWEEN, regex: /BETWEEN\b/iuy, text: tE },
              {
                type: I.LIMIT,
              ...
              },
              {
                ...
                regex: AE(E.reservedClauses, E.identChars),
                text: tE,
              },
              {
                type: I.RESERVED_SELECT,
                regex: AE(E.reservedSelect, E.identChars),
                text: tE,
              },
              {
                type: I.RESERVED_SET_OPERATION,
                regex: AE(E.reservedSetOperations, E.identChars),
                text: tE,
              },
              { type: I.WHEN, regex: /WHEN\b/iuy, text: tE },
              { type: I.ELSE, regex: /ELSE\b/iuy, text: tE },
              { type: I.THEN, regex: /THEN\b/iuy, text: tE },
              {
                type: I.RESERVED_JOIN,
                regex: AE(E.reservedJoins, E.identChars),
                text: tE,
              },
              { type: I.AND, regex: /AND\b/iuy, text: tE },
              { type: I.OR, regex: /OR\b/iuy, text: tE },
              {
                type: I.XOR,
              ...
              },
              {
                ...
                regex: AE(E.reservedFunctionNames, E.identChars),
                text: tE,
              },
              {
                type: I.RESERVED_KEYWORD,
                regex: AE(E.reservedKeywords, E.identChars),
                text: tE,
              },
            ]);
          }
            ...
            return this.validRules([
              {
                ...
                regex: E.variableTypes
                  ? ((A = E.variableTypes),
                    EE(
                      A.map((E) => ("regex" in E ? E.regex : NE(E))).join("|"),
                    ))
                  : void 0,
              },
              { type: I.STRING, regex: LE(E.stringTypes) },
              { type: I.IDENTIFIER, regex: CE(E.identChars) },
              { type: I.DELIMITER, regex: /[;]/uy },
              { type: I.COMMA, regex: /[,]/y },
              { type: I.OPEN_PAREN, regex: RE("open", E.extraParens) },
              { type: I.CLOSE_PAREN, regex: RE("close", E.extraParens) },
              {
                type: I.OPERATOR,
                regex:
                  ((R = [
                    ...
                    ">=",
                    "!=",
                    ...(null !== (T = E.operators) && void 0 !== T ? T : []),
                  ]),
                  EE(`${m(R).map(j).join("|")}`)),
              },
              { type: I.ASTERISK, regex: /[*]/uy },
              { type: I.DOT, regex: /[.]/uy },
            ]);
          }
          buildParamRules(E, T) {
            ...
            const O = {
              named:
                ...
                (null === (R = E.paramTypes) || void 0 === R
                  ? void 0
                  : R.named) ||
                [],
              quoted:
                (null == T ? void 0 : T.quoted) ||
                (null === (A = E.paramTypes) || void 0 === A
                  ? void 0
                  : A.quoted) ||
                [],
              numbered:
                (null == T ? void 0 : T.numbered) ||
                (null === (S = E.paramTypes) || void 0 === S
                  ? void 0
                  : S.numbered) ||
                [],
              positional:
            ...
            return this.validRules([
              {
                ...
                regex: SE(O.named, _E(E.paramChars || E.identChars)),
                key: (E) => E.slice(1),
              },
              {
                type: I.QUOTED_PARAMETER,
                regex: SE(O.quoted, OE(E.identTypes)),
                key: (E) =>
                  (({ tokenKey: E, quoteChar: T }) =>
                    E.replace(new RegExp(j("\\" + T), "gu"), T))({
        ...
        const tE = (E) => K(E.toUpperCase()),
          rE = (E) => E.flatMap(GE),
          GE = (E) => oE(HE(E)).map((E) => E.trim()),
          nE = /[^[\]{}]+/y,
          iE = /\{.*?\}/y,
          aE = /\[.*?\]/y,
          HE = (E) => {
            ...
            for (; T < E.length; ) {
              nE.lastIndex = T;
              const A = nE.exec(E);
              A && (R.push([A[0].trim()]), (T += A[0].length)),
                (aE.lastIndex = T);
              const S = aE.exec(E);
              if (S) {
                const E = S[0]
          ...
          oE = ([E, ...T]) =>
            void 0 === E
              ? [""]
              : oE(T).flatMap((T) => E.map((E) => E.trim() + " " + T.trim())),
          BE = d({
            keywords: [
              "ALL",
              "AND",
          ...
          FE = rE(["SELECT [ALL | DISTINCT] [AS STRUCT | AS VALUE]"]),
          VE = rE([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          return (function (E) {
            ...
            (function (E) {
              ...
              for (let A = 0; A < E.length; A++) {
                const S = E[A];
                if (
                  (e.ARRAY(S) || e.STRUCT(S)) &&
                  "<" ===
                    (null === (T = E[A + 1]) || void 0 === T ? void 0 : T.text)
                ) {
                  const T = uE(E, A + 1),
                    N = E.slice(A, T + 1);
                  R.push({
                    type: I.IDENTIFIER,
                    raw: N.map(cE("raw")).join(""),
                    text: N.map(cE("text")).join(""),
                    start: S.start,
                  }),
                    (A = T);
                } else R.push(S);
        ...
        const cE = (E) => (T) =>
          T.type === I.IDENTIFIER || T.type === I.COMMA ? T[E] + " " : T[E];
        function uE(E, T) {
          let R = 0;
        ...
        const mE = d({
          ...
          yE = rE(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
          fE = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          qE = rE(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          jE = rE([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
        ...
        const AT = d({
          ...
          IT = rE(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          NT = rE([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
        ...
        const eT = d({
          ...
          UT = rE(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
          sT = rE(["JOIN", "{LEFT | RIGHT} [OUTER] JOIN", "INNER JOIN"]),
          tT = rE(["{ROWS | RANGE | GROUPS} BETWEEN"]),
          rT = d({
            all: [
              "ADD",
              "AGENT",
          ...
          nT = rE(["SELECT [ALL | DISTINCT | UNIQUE]"]),
          iT = rE([
            "WITH",
            "FROM",
            "WHERE",
          ...
          aT = rE(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          HT = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
        ...
        const YT = d({
          ...
          KT = rE(["UNION [ALL]", "EXCEPT", "INTERSECT", "MINUS"]),
          dT = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
        ...
        function QT(E) {
          return E.map((T, R) => {
            const A = E[R - 1] || C,
              S = E[R + 1] || C;
            return e.WINDOW(T) && S.type === I.OPEN_PAREN
              ? Object.assign(Object.assign({}, T), {
                  type: I.RESERVED_FUNCTION_NAME,
                })
              : "ITEMS" !== T.text ||
                  T.type !== I.RESERVED_KEYWORD ||
        ...
        const vT = d({
          ...
          jT = rE(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          zT = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          UR = rE(["{ROWS | RANGE | GROUPS} BETWEEN"]),
          sR = d({
            aggregate: [
              "APPROX_COUNT_DISTINCT",
              "AVG",
          ...
          nR = rE(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          iR = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
        ...
        const oR = d({
          ...
          YR = rE(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          FR = rE([
            "WITH",
            "FROM",
            "WHERE",
          ...
          VR = rE(["UNION [ALL | DISTINCT]", "EXCEPT", "INTERSECT", "MINUS"]),
          lR = rE([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
        ...
        const XR = d({
          ...
          hR = rE(["UNION [ALL]", "MINUS", "EXCEPT", "INTERSECT"]),
          KR = rE([
            "[INNER] JOIN",
            "[NATURAL] {LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{CROSS | NATURAL} JOIN",
          ...
          yR = {
            ...
            postgresql: class extends q {
              tokenizer() {
                return new sE({
                  reservedClauses: lT,
                  reservedSelect: VT,
                  reservedSetOperations: WT,
                  reservedJoins: pT,
                  reservedPhrases: XT,
                  reservedKeywords: FT,
                  reservedFunctionNames: YT,
                  nestedBlockComments: !0,
                  extraParens: ["[]"],
                  stringTypes: [
                    "$$",
          ...
          xR = (E, T = {}) => {
            ...
            const R = (function (E) {
              if ("string" == typeof E.language && !fR.includes(E.language))
                throw new JR(`Unsupported SQL dialect: ${E.language}`);
              if ("multilineLists" in E)
                throw new JR("multilineLists config is no more supported.");
              if ("newlineBeforeOpenParen" in E)
                throw new JR(
                  "newlineBeforeOpenParen config is no more supported.",
                );
              if ("newlineBeforeCloseParen" in E)
                throw new JR(
                  "newlineBeforeCloseParen config is no more supported.",
                );
              if ("aliasAs" in E)
                throw new JR("aliasAs config is no more supported.");
              ...
              return (
                E.params &&
                  !(
                    (T = E.params) instanceof Array ? T : Object.values(T)
            ...
            })(Object.assign(Object.assign({}, bR), T));
            return new ("string" == typeof R.language
              ? yR[R.language]
              : R.language)(R).format(E);
          };
